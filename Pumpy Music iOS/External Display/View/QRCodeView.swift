...
struct QRCodeView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            QRCodeView(width: 1080, height: 1920)
                .environmentObject(ExternalDisplayManager(username: "Test", musicManager: MusicManager(username: "Test", settingsManager: SettingsManager(username: "Test"))))
                .previewLayout(.sizeThatFits)
                .frame(width: 1080, height: 1920)
            QRCodeView(width: 1920, height: 1080)
                .environmentObject(ExternalDisplayManager(username: "Test", musicManager: MusicManager(username: "Test", settingsManager: SettingsManager(username: "Test"))))
                .previewLayout(.sizeThatFits)
